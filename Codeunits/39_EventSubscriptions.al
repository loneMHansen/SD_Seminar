...
// Chapter 7 - Lab 2-1
{
  ...
  local procedure OnRunOnAfternavigateFindRecords(var DocumentEntry : Record "Document Entry";DocNoFilter : Text;PostingDateFilter : Text);
  var
  ...
  local procedure OnRunOnAfterNavigateShowRecords(TableID : Integer; DocNoFilter : Text; PostingDateFilter : Text; ItemTrackingSearch : Boolean);
  var
    SeminarLedgerEntry : record "Seminar Ledger Entry"; 
    PostedSeminarRegHeader : record "Posted Seminar Reg. Header";
  begin
